...
html_temp = """
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">Department of Artificial Intelligence & Data Science</p></center>
...
if st.button("About"):
  st.subheader("Developed by Dr Uday Pratap Singh")
